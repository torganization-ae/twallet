...
object AvalancheConfig : MBlockchainConfig {
    ...
    override val symbolIcon = app.twallet.air.icons.R.drawable.ic_symbol_avalanche
    override val symbolIconPadded = app.twallet.air.icons.R.drawable.ic_symbol_avalanche
    override val receiveOrnamentImage =
        app.twallet.air.icons.R.drawable.receive_ornament_avalanche_light
