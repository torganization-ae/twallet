package app.twallet.air.uicomponents.widgets.coverFlow
...
class WCoverFlowView @JvmOverloads constructor(
    ...
    private fun createNoImageDrawable() {
        ...
        val iconRes = if (ThemeManager.isDark)
            app.twallet.air.icons.R.drawable.img_nft_no_image_dark
        else
            app.twallet.air.icons.R.drawable.img_nft_no_image_light
