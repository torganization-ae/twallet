...
#if DEBUG
    extension ApiSite {
        public static let sampleTelegram = Self(
            url: "https://t.me/",
            name: "Sample name",
            icon: "",
            manifestUrl: "",
        ...
        public static func sample(categoryId: Int = 0) -> Self {
            Self(
                url: "https://t.me/",
                name: "@push (name)",
                icon: "",
        ...
        public static func randomSample(categoryId: Int, uniquenessIndex: Int) -> Self {
